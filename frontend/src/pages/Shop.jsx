...
const DEFAULT_PRODUCTS = [
    ...
    // Massively expanded 30 new traditional items
    {id: 37, name: "Raagi Kali Powder", emoji: "🌾", price: 140, benefit: "ராகி களி - Bone Strength", category: "Traditional"},
    {id: 38, name: "Kambu Koozh Powder", emoji: "🌾", price: 130, benefit: "கம்பு கூழ் - Cooling Body", category: "Traditional"},
    {id: 39, name: "Thinai Kali", emoji: "🌾", price: 150, benefit: "தினை களி - High Protein", category: "Traditional"},
    {id: 40, name: "Varagu Kali", emoji: "🌾", price: 160, benefit: "fiber Rich", category: "Traditional"},
    {id: 41, name: "Samai Kali", emoji: "🌾", price: 155, benefit: "Digestion Control", category: "Traditional"},
    {id: 42, name: "Kudiraivali Kali", emoji: "🌾", price: 170, benefit: "Iron Rich Grain", category: "Traditional"},
    {id: 43, name: "Sigappu Kavuni Kali", emoji: "🌾", price: 220, benefit: "Traditional Antioxidant", category: "Traditional"},
    {id: 44, name: "Karuppu Kavuni Kali", emoji: "🌾", price: 240, benefit: "Ancient Immunity", category: "Traditional"},
    {id: 45, name: "Bajra Flour (Kambu)", emoji: "🌾", price: 120, benefit: "Energy & Vitality", category: "Supplements"},
    {id: 46, name: "Foxtail Millet Flour", emoji: "🌾", price: 140, benefit: "Multivitamin Grain", category: "Supplements"},
    {id: 47, name: "Little Millet Flour", emoji: "🌾", price: 135, benefit: "Easy Digestion", category: "Supplements"},
    {id: 48, name: "Barnyard Flour", emoji: "🌾", price: 150, benefit: "Natural Calcium", category: "Supplements"},
    {id: 49, name: "Health Mix (Nutri-Blend)", emoji: "🌾", price: 280, benefit: "Compreshensive Nutrition", category: "Supplements"},
    {id: 50, name: "Navadhanya Kali", emoji: "🌾", price: 320, benefit: "All Grains Power", category: "Traditional"},
    {id: 51, name: "Dry Ginger Kali (Sukku)", emoji: "🫚", price: 180, benefit: "Stomach Health", category: "Traditional"},
    {id: 52, name: "Fenugreek Kali Mix", emoji: "🌱", price: 190, benefit: "Uterus Health", category: "Traditional"},
    {id: 53, name: "Barley Porridge Powder", emoji: "🌾", price: 140, benefit: "Water Balance", category: "Traditional"},
    {id: 54, name: "Corn Flour (Pure Corn)", emoji: "🌽", price: 110, benefit: "Light Nutrients", category: "Food"},
    {id: 55, name: "Multi-Grain Porridge", emoji: "🌾", price: 250, benefit: "Complete Morning Drink", category: "Food"},
    {id: 56, name: "Jowar Flour (Cholam)", emoji: "🌾", price: 130, benefit: "Body Weight Balance", category: "Supplements"},
    {id: 57, name: "Traditional Sathu Maavu", emoji: "🌾", price: 240, benefit: "Heritage Energy", category: "Traditional"},
    {id: 58, name: "Black Sesame Kali", emoji: "🌱", price: 210, benefit: "Superior Strength", category: "Traditional"},
    {id: 59, name: "Groundnut Kali Power", emoji: "🥜", price: 190, benefit: "High Protein Mix", category: "Traditional"},
    {id: 60, name: "Sprouted Ragi Powder", emoji: "🌾", price: 180, benefit: "Best Calcium Source", category: "Supplements"},
    {id: 61, name: "Sprouted Kambu Powder", emoji: "🌾", price: 170, benefit: "Cooling & Digestion", category: "Supplements"},
    {id: 62, name: "Wheat Rava (Samba)", emoji: "🌾", price: 140, benefit: "Low Glycemic Index", category: "Food"},
    {id: 63, name: "Red Rice Puttu Mix", emoji: "🌾", price: 160, benefit: "Traditional Iron", category: "Traditional"},
    {id: 64, name: "Bamboo Rice (Moongil)", emoji: "🌾", price: 350, benefit: "Joint Pain Relief", category: "Supplements"},
    {id: 65, name: "Black Gram Kali Mix", emoji: "🫘", price: 220, benefit: "Spinal Strength", category: "Traditional"},
    {id: 66, name: "Masala Kool Mix", emoji: "🍲", price: 150, benefit: "Spicy Porridge Health", category: "Traditional"}
];
